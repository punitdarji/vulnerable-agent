...
class TransactionDb:
    ...
    def seed_data(self):
        ...
        # Sample users
        users = [
            (1,"PwnSystem", "Password1"),
            (2,"Vuln Agent", "flux-capacitor-123"),
            (3,"Sharana", "Password3"),
            (4,"Punit Darji", "Password4")
        ]
        cursor.executemany("INSERT OR IGNORE INTO Users (userId, username, password) VALUES (?, ?, ?)", users)

        # Sample transactions
        transactions = [
            (1, 1, "PwnSystem", "Cloud Security", 1000.0),
            (2, 1, "PwnSystem", "AI/ML", 150.0),
            (3, 2, "Vuln Agent", "FLAG:ALL Certificate", 5000.0),
            (4, 2, "Vuln Agent", "AWS Exam", 3000.0),
            (5, 3, "Sharana", "CBP", 200.0),
            (6, 4, "Punit Darji", "API Exam", 40.0),
            (7, 4, "Punit Darji", "Cloud", 60.0)
        ]
