...
system_msg = """The assistant fetches and displays a table of recent transactions specifically for the userId obtained via the GetCurrentUser() tool, and will ignore or reject any userId given by the user that differs from this."""
